...
A simple, secure, and modern password generator built with **.NET MAUI** and **CommunityToolkit.MVVM**.

## 📱 Features
* **Custom Length:** Generate passwords from 5 to 50 characters.
...
3. Select the target device (Android/iOS Simulator).
4. Build and Run!
